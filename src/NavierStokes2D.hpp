...
protected:
  ...
  // Additional operators needed for PCD preconditioner
  TrilinosWrappers::SparseMatrix pressure_laplacian; 
  TrilinosWrappers::SparseMatrix pressure_convection;
  std::unique_ptr<TrilinosWrappers::PreconditionBase> pcd_inner_F;
  std::unique_ptr<TrilinosWrappers::PreconditionBase> pcd_inner_Mp;
  std::unique_ptr<TrilinosWrappers::PreconditionBase> pcd_inner_Ap;

  // Additional pointers needed for SIMPLE preconditioner
  std::unique_ptr<TrilinosWrappers::PreconditionBase> simple_inner_F;
  std::unique_ptr<TrilinosWrappers::PreconditionBase> simple_inner_S;

  // Base pointer capable of managing ANY external advanced block preconditioner 
