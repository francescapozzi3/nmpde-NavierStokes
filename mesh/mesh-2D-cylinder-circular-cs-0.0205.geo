...
h_far    = 0.0205;    // element size far from circle (background)
h_circle = 0.0102; // element size on circle boundary
...
// --- Curve loops ---
Curve Loop(1) = {1, 2, 3, 4};          // outer rectangle (CCW)
Curve Loop(2) = {5, 6, 7, 8};          // circle (CCW, hole)

// --- Surface (domain minus circle) ---
Plane Surface(1) = {1, -2};    // note: -2 means circle is a hole
